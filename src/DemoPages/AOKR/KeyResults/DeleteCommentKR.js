...
const DeleteCommentKR = ({ classes, ...props }) => {
  const { addToast } = useToasts();

  const onDelete = (id) => {
    props.deletecommentsKR(id, () =>
...
const mapStateToProps = (state) => ({
  commentsKRList: state.commentsKR.listCKR,
});

const mapActionToProps = {
  deletecommentsKR: actions.DeleteCKR,
};

export default connect(mapStateToProps, mapActionToProps)(DeleteCommentKR);
