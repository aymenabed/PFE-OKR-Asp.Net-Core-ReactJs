...
class CopyObjective extends React.Component {
  constructor(props) {
    super(props);
...
<Typography variant="inherit">Assign to</Typography>
</MenuItem>
      ...
      <Fragment>
        ...
        >
          ...
          <Rodal
            ...
            showMask={false}
          >
            <ModalHeader>ASSIGN KEY RESULT AS AN OBJECTIVE</ModalHeader>
            <ModalBody>
            ...
            <ModalFooter>
              ...
              <Button color="primary" className="btn-shadow btn-wide btn-pill"  onClick={this.hide.bind(this)}>
                Save
              </Button>
            </ModalFooter>
          </Rodal>
