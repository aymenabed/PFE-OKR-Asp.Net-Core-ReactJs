...
const AddCommentKR = ({ classes, ...props }) => {
      ...
      >
        <div className="nav-item-btn text-center">
          <Button
            ...
            onClick={() => show(this)}
          >
            Write your comment for Key Result
          </Button>
        </div>
        ...
        >
          ...
          <Formik
            ...
            onSubmit={(fields, { resetForm }) => {
              ...
              props.createCommentsKR(post, onSuccess);
              hide();
            }}
            render={({
              values,
...
const mapActionToProps = {
  createCommentsKR: actions.createCKR,
};

export default connect(mapStateToProps, mapActionToProps)(AddCommentKR);
