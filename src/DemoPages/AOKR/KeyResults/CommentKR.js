...
import AddCommentKR from "./AddCommentKR";

import DeleteCommentKR from "./DeleteCommentKR";
import EditCommentKR from "./EditCommentKR";
      ...
      <CardBody>
        <div className="scroll-area-xlg">
          <PerfectScrollbar>
            ...
            <br></br>
            <AddCommentKR id={props.id}></AddCommentKR>
            <br></br>
          </PerfectScrollbar>
        </div>
      </CardBody>
...
export function FadeMenu(props) {
  ...
  return (
    <div className="btn-actions-pane-right text-capitalize actions-icon-btn ">
      ...
      >   <EditCommentKR  comment={props.comment}></EditCommentKR>
          <DeleteCommentKR  comment={props.comment}></DeleteCommentKR>
      </Menu>
    </div>
  );
}