...
const DCandidateForm = ({ classes, ...props }) => {
  ...
  return (
    <Fragment>
      ...
      >
        <ModalHeader className="ModalHeader">Add a new objective</ModalHeader>
        ...
        <Formik
          ...
          onSubmit={(fields, { resetForm }) => {
            ...
            const onSuccess = () => {
              ...
              addToast("Objective added successfully", { appearance: "success" });
            };
            ...
            <Form>
              <ModalBody>
                ...
                <PrettoSlider
                  ...
                  onChange={(event, value) => setFieldValue("progress", value)}
...
const mapStateToProps = (state) => ({
  objectifs: state.objectifs.list,
});

const mapActionToProps = {
  createobjectifs: actions.create,
};
