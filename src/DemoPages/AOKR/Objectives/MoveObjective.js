...
const MoveObjective = ({ classes, ...props }) => {
  ...
  return (
    <Fragment>
      ...
      >
        ...
        >
          <ModalHeader className="ModalHeader">Edit the Key Result</ModalHeader>
          <ModalBody>
            <PanelBar
              children={components}
              expandMode={"single"}
...
const mapActionToProps = {
  ...
  updateobjectifs: actionsO.update,
};

export default connect(mapStateToProps, mapActionToProps)(MoveObjective);
