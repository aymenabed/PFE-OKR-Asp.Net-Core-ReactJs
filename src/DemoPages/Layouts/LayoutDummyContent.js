...
const LayoutsDummyContent = () => (
	<Fragment>
		<PageTitle
			heading="Horizontal Header Menu"
		...
		<p>
			...
			pede. Sed lectus. Donec mollis hendrerit risus. Phasellus nec sem in justo
...
export default LayoutsDummyContent;
